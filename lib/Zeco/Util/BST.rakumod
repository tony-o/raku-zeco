...
ecosystem software will generate.
=end SYNOPSIS


=head2 sub index(IO() --> BST)
...
=head3 method find-partial-index(IO(), Str:D --> List)
...
=head3 method find-index(IO(), Str:D --> List)
